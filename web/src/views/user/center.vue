<template>
  <div class="flex flex-col w-full sm:flex-row dark:bg-regal-dark">
    ...
    <el-tabs v-model="activeName" class="w-full pl-3 pr-3 mt-2 ml-0 bg-white dark:bg-regal-dark sm:mt-0 sm:ml-2">
